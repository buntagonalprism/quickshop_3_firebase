...
### Deploying Manually
Run `firebase deploy --only functions --project=<PROJECT>`
...
- `FB_FUNCTIONS_CREDENTIALS`: A ghoogle cloud service account JSON key granting permissions to deploy to Firebase Functions. 
